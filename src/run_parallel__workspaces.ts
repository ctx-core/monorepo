...
export async function run_parallel__workspaces(cmd_a1:string[], opts:monorepo_thread_opts_type = {}) {
	...
	async function _promise(project:project_type):Promise<string> {
