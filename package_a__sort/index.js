...
/** @typedef {import('../sorted_pkg_o_a_/index.d.ts').pnpm_list_package_T}pnpm_list_package_T */
/** @typedef {import('./index.d.ts').package_a__sort__params_T}package_a__sort__params_T */
/**
